...
for num_tpus in num_tpus_list:
  with open('batchTestResults/model{}_{}tpus_results.csv'.format(args.nummodels, num_tpus), "w") as csvout:
...
for threads in thread_list:
  with open('batchTestResults/model{}_cpu_{}thread_results.csv'.format(args.nummodels, threads), "w") as csvout:
    writer = csv.writer(csvout)
