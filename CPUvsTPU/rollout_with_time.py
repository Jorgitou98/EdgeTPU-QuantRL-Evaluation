...
def create_parser(parser_creator=None):
    ...
    parser.add_argument(
        ...
        help="Select which GPUs set as available.")
    parser.add_argument(
        "--monitor",
        default=False,
        action="store_true",
    ...
    parser.add_argument(
        ...
        default={},
        type=set,
        help="Set with the CPUs ids to place execution tasks on"
    )
    parser.add_argument(
        "--num-cpus-ray",
        default=0,
...
def run(args, parser):
    ...
    ##########################
    # Disable exploring: we only want to evaluate previously trained performance
    ...
    if args.num_cpus_ray > 0 :
        ray.init(num_cpus=args.num_cpus_ray)
    else:
        ray.init()
